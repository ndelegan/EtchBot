"""
    ...
    Driver for the water pump to clear the bubbles in the membrane.
        
    Authors: UIC Chicago Tech Circle Team (Lisette Ruano)
    Collaborator(s): Argonne National Laboratory (Nazar Delegan, Clayton Devault)
    Date Created: 06/26/2024
    Citation: https://wiki.dfrobot.com/Light_and_Motor_Driver_for_Python_SKU_DRI0050
